 ...
 const BookDetailScreen({super.key,});
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<BookDetailsCubit, BookDetailsState>(
      ...
      buildWhen: (previous, current) => current is BookDetailsLoading || current is BookDetailsSuccess || current is BookDetailsError,
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () {
                          context.read<BookDetailsCubit>().addWishList(state.bookModel!.id );
                        },
                  ...
                  ClipRRect(
                    ...
                    child: CustomNetworkImage(url: state.bookModel?.image ?? '', width: 183.w, height: 271.h)),
